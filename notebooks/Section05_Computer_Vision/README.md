...
## **📝 Section Review**
Computer Vision is one of the most impactful fields in modern AI, powering systems that interpret and understand visual information.  
In this section, we explore how neural networks learn from images, why traditional dense networks fall short, and how specialized architectures like CNNs and Autoencoders extract meaningful patterns from high-dimensional visual data.

This section contains **three chapters**, each building toward a strong understanding of deep architectures used in real-world vision tasks.

---

## **📘 Chapter 00 — Convolutional Neural Networks**
This chapter introduces the core building block of modern vision systems: the **Convolutional Neural Network (CNN)**.  
...
## **📘 Chapter 01 — Deep CNN Architectures (AlexNet, ResNet)**
This chapter moves beyond basic CNNs into **state-of-the-art architectures** that shaped the evolution of deep learning.  
...
In this chapter, we explore **Autoencoders**, neural networks designed to compress and reconstruct data.  
